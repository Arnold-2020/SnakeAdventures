...
public class HelpsviaMenu   {
	...
	public static void render(Graphics g, int menuoption) {
		...
		evilapple = GameFrame.loadImage("newevilapple.png");
		 ...
		 bonusapple = GameFrame.loadImage("bonusapple.png");
